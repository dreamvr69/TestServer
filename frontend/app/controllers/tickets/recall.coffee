...
TicketsRecallController = Ember.Controller.extend TicketBaseControllerMixin, ToastMixin,
  ...
  actions:
    close: (ticket)->
      $.ajax
        ...
        url: "#{config.protocol}://#{config.host}/ember/ticket/recalls/#{ticket.id}/close"
        success: (data) =>
...
`export default TicketsRecallController`
